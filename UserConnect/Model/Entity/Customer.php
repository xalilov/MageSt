 ...
 */
class Olko_UserConnect_Model_Entity_Customer extends Mage_Eav_Model_Entity_Abstract
{
    /**
     * Initiate resources
     *
    ...
    public function __construct()
    {
        ...
        $this->setConnection(// 'customer_read', 'customer_write');
          $resource->getConnection('userconnectted_read'),
          $resource->getConnection('userconnectted_write')
        );
    }
