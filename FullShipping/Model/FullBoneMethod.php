<?php
  ...
  #doc
  #  classname:  Olko_FullShipping_Model_Carrier_FullBoneMethod
  #  scope:    PUBLIC
  #
  #/doc
  
  class Olko_FullShipping_Model_Carrier_FullBoneMethod extends Mage_Shipping_Model_Carrier_Abstract
  {
    #  internal variables
    protected $_code = 'fullshipping';
