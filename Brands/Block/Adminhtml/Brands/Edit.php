<?php
  ...
  * Olko
  */
  class Olko_Brands_Block_Adminhtml_Brands_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
  {
    ...
    public function getHeaderText()
    {
      ...
      {
        return Mage::helper('brands')->__("Edit Brand '%s'", 
          $this->htmlEscape(Mage::registry('brands_data')->getTitle())
        );
      } else {
