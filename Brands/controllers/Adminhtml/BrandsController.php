<?php
  ...
  * Brands Controller
  */
  class Olko_Brands_Adminhtml_BrandsController extends Mage_Adminhtml_Controller_action
  {
    protected function _initAction()
    {
      $this->loadLayout()->_setActiveMenu('brands/items')->
    ...
    public function editAction()
    {
      ...
      if ($brandsModel->getId() || $brandsId == 0) {
        ...
        $this->_addBreadcrumb(Mage::helper('adminhtml')->__('BrandsManager'),
          Mage::helper('adminhtml')->__('Brands Manager')
        );
        
        $this->_addBreadcrumb(Mage::helper('adminhtml')->__('BrandDescription'), 
        ...
        Mage::getSingleton('adminhtml/session')->addError(
            Mage::helper('brands')->__('Brand does not exist')
        );
        $this->_redirect('*/*/');
      }
    }
    ...
    public function saveAction()
    {
      if ( $this->getRequest()->getPost() ) {
        try {
          ...
          $brandsModel->addData($postData)->setUpdateTime(
